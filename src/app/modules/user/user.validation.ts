...
export const createUserZodSchema = z.object({
    ...
    // name: z.object({
    //  firstName : z.string({ invalid_type_error: "Name must be string" }).min(2, { message: "Name too short, Minimum 2 character long" }).max(50, { message: "Name too long it" }),
    //  lastName: z.string({ invalid_type_error: "Name must be string" }).min(2, { message: "Name too short, Minimum 2 character long" }).max(50, { message: "Name too long it" })
    // }),
